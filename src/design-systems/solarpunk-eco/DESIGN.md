# DESIGN.md — Solarpunk / Eco

## Aesthetic
soft-pastel

## Tone
Оптимистичный, солнечный, зелёный

## Colors
bg: #f5fff0, accent: #8bc34a, accent2: #ffcd00
...
- Соблюдай Оптимистичный, солнечный, зелёный тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #8bc34a, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #d0e0c0, text #1a2e1a | bg #f0f2f5 | border #8bc34a | opacity .4 |
...
|---|---|---|---|
| Default | #f5fff0 | #d0e0c0 | #1a2e1a |
| Focus | #f5fff0 | #8bc34a (+shadow) | #1a2e1a |
| Error | #f5fff0 | #e53935 | #e53935 |
| Disabled | #f0f2f5 | #d0e0c0 | #6a8a6a |
- Height: 36px | Radius: 12px | Padding: 0 12px

## Card Specs
- Background: #ffffff | Border: 1px solid #d0e0c0 | Radius: 12px
- Padding: 16px | Hover: border #8bc34a (if interactive)

## Navigation
- Link: #6a8a6a, hover #1a2e1a, active #8bc34a
- Tab active: bottom 2px #8bc34a, color #8bc34a
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #8bc34a outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #8bc34a for active
