# DESIGN.md — Swiss / International Style

## Aesthetic
editorial-magazine

## Tone
Объективный, сеточный, типографичный

## Colors
bg: #f5f5f0, accent: #ffcc00, accent2: #cc0000
...
- Соблюдай Объективный, сеточный, типографичный тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #ffcc00, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #333333, text #1a1a1a | bg #f0f2f5 | border #ffcc00 | opacity .4 |
...
|---|---|---|---|
| Default | #f5f5f0 | #333333 | #1a1a1a |
| Focus | #f5f5f0 | #ffcc00 (+shadow) | #1a1a1a |
| Error | #f5f5f0 | #cc0000 | #cc0000 |
| Disabled | #f0f2f5 | #333333 | #666666 |
- Height: 36px | Radius: 0px | Padding: 0 12px

## Card Specs
- Background: #ffffff | Border: 1px solid #333333 | Radius: 0px
- Padding: 16px | Hover: border #ffcc00 (if interactive)

## Navigation
- Link: #666666, hover #1a1a1a, active #ffcc00
- Tab active: bottom 2px #ffcc00, color #ffcc00
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #ffcc00 outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #ffcc00 for active
