# DESIGN.md — Music / Audio App

## Aesthetic
cyberpunk

## Tone
Иммерсивный, тёмный, неоновый

## Colors
bg: #0a0a14, accent: #ff00aa, accent2: #00ffcc
...
- Соблюдай Иммерсивный, тёмный, неоновый тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #ff00aa, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #2a2a3e, text #e8e8f0 | bg #12121e | border #ff00aa | opacity .4 |
| Ghost | bg transparent, text #7a7a9a | bg #12121e | text #e8e8f0 | opacity .4 |
...
|---|---|---|---|
| Default | #0a0a14 | #2a2a3e | #e8e8f0 |
| Focus | #0a0a14 | #ff00aa (+shadow) | #e8e8f0 |
| Error | #0a0a14 | #ff3366 | #ff3366 |
| Disabled | #12121e | #2a2a3e | #7a7a9a |
- Height: 36px | Radius: 6px | Padding: 0 12px

## Card Specs
- Background: #12121e | Border: 1px solid #2a2a3e | Radius: 6px
- Padding: 16px | Hover: border #ff00aa (if interactive)

## Navigation
- Link: #7a7a9a, hover #e8e8f0, active #ff00aa
- Tab active: bottom 2px #ff00aa, color #ff00aa
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #ff00aa outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #ff00aa for active
