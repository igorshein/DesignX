# DESIGN.md — Social Media Platform

## Aesthetic
playful

## Tone
Яркий, динамичный, контент-первый

## Colors
bg: #ffffff, accent: #ff3b5c, accent2: #00c4cc
...
- Соблюдай Яркий, динамичный, контент-первый тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #ff3b5c, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #e0e0e6, text #1a1a2e | bg #f0f2f5 | border #ff3b5c | opacity .4 |
| Ghost | bg transparent, text #65657a | bg #f0f2f5 | text #1a1a2e | opacity .4 |
...
|---|---|---|---|
| Default | #ffffff | #e0e0e6 | #1a1a2e |
| Focus | #ffffff | #ff3b5c (+shadow) | #1a1a2e |
| Error | #ffffff | #ff1744 | #ff1744 |
| Disabled | #f0f2f5 | #e0e0e6 | #65657a |
- Height: 36px | Radius: 12px | Padding: 0 12px

## Card Specs
- Background: #f5f5f5 | Border: 1px solid #e0e0e6 | Radius: 12px
- Padding: 16px | Hover: border #ff3b5c (if interactive)

## Navigation
- Link: #65657a, hover #1a1a2e, active #ff3b5c
- Tab active: bottom 2px #ff3b5c, color #ff3b5c
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #ff3b5c outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #ff3b5c for active
