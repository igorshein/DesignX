# DESIGN.md — Travel / Hospitality

## Aesthetic
luxury-refined

## Tone
Тёплый, вдохновляющий, премиальный

## Colors
bg: #fef9ef, accent: #d4a373, accent2: #264653
...
- Соблюдай Тёплый, вдохновляющий, премиальный тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #d4a373, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #ede3d5, text #2d1810 | bg #f0f2f5 | border #d4a373 | opacity .4 |
| Ghost | bg transparent, text #8a7565 | bg #f0f2f5 | text #2d1810 | opacity .4 |
...
|---|---|---|---|
| Default | #fef9ef | #ede3d5 | #2d1810 |
| Focus | #fef9ef | #d4a373 (+shadow) | #2d1810 |
| Error | #fef9ef | #e76f51 | #e76f51 |
| Disabled | #f0f2f5 | #ede3d5 | #8a7565 |
- Height: 36px | Radius: 6px | Padding: 0 12px

## Card Specs
- Background: #ffffff | Border: 1px solid #ede3d5 | Radius: 6px
- Padding: 16px | Hover: border #d4a373 (if interactive)

## Navigation
- Link: #8a7565, hover #2d1810, active #d4a373
- Tab active: bottom 2px #d4a373, color #d4a373
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #d4a373 outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #d4a373 for active
