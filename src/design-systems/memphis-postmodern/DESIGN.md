# DESIGN.md — Memphis / Postmodern

## Aesthetic
maximalist-chaos

## Tone
Яркий, хаотичный, смелый

## Colors
bg: #ffe0e0, accent: #ff0066, accent2: #00ccff
...
- Соблюдай Яркий, хаотичный, смелый тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #ff0066, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #ff0066, text #1a0a0a | bg #f0f2f5 | border #ff0066 | opacity .4 |
| Ghost | bg transparent, text #884444 | bg #f0f2f5 | text #1a0a0a | opacity .4 |
...
|---|---|---|---|
| Default | #ffe0e0 | #ff0066 | #1a0a0a |
| Focus | #ffe0e0 | #ff0066 (+shadow) | #1a0a0a |
| Error | #ffe0e0 | #ff0066 | #ff0066 |
| Disabled | #f0f2f5 | #ff0066 | #884444 |
- Height: 36px | Radius: 20px | Padding: 0 12px

## Card Specs
- Background: #ffe8d0 | Border: 1px solid #ff0066 | Radius: 20px
- Padding: 16px | Hover: border #ff0066 (if interactive)

## Navigation
- Link: #884444, hover #1a0a0a, active #ff0066
- Tab active: bottom 2px #ff0066, color #ff0066
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #ff0066 outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #ff0066 for active
