# DESIGN.md — Healthcare / Medical

## Aesthetic
scandinavian

## Tone
Чистый, стерильный, доверительный

## Colors
bg: #f8fbf8, accent: #2e7d32, accent2: #66bb6a
...
- Соблюдай Чистый, стерильный, доверительный тон во всех текстах
...
| Ghost | bg transparent, text #6b7a6b | bg #f0f2f5 | text #1a2e1a | opacity .4 |
...
|---|---|---|---|
| Default | #f8fbf8 | #dce5dc | #1a2e1a |
| Focus | #f8fbf8 | #2e7d32 (+shadow) | #1a2e1a |
| Error | #f8fbf8 | #c62828 | #c62828 |
| Disabled | #f0f2f5 | #dce5dc | #6b7a6b |
...
## Navigation
- Link: #6b7a6b, hover #1a2e1a, active #2e7d32
