# DESIGN.md — Enterprise Admin Panel

## Aesthetic
brutalist-raw

## Tone
Функциональный, плотный, минималистичный

## Colors
bg: #0a0a0a, accent: #00ff00, accent2: #00aaff
...
- Соблюдай Функциональный, плотный, минималистичный тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #00ff00, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #2a2a2a, text #f0f0f0 | bg #1a1a1a | border #00ff00 | opacity .4 |
| Ghost | bg transparent, text #707070 | bg #1a1a1a | text #f0f0f0 | opacity .4 |
...
|---|---|---|---|
| Default | #0a0a0a | #2a2a2a | #f0f0f0 |
| Focus | #0a0a0a | #00ff00 (+shadow) | #f0f0f0 |
| Error | #0a0a0a | #ff0000 | #ff0000 |
| Disabled | #1a1a1a | #2a2a2a | #707070 |
- Height: 36px | Radius: 0px | Padding: 0 12px

## Card Specs
- Background: #1a1a1a | Border: 1px solid #2a2a2a | Radius: 0px
- Padding: 16px | Hover: border #00ff00 (if interactive)

## Navigation
- Link: #707070, hover #f0f0f0, active #00ff00
- Tab active: bottom 2px #00ff00, color #00ff00
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #00ff00 outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #00ff00 for active
