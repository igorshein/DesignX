# DESIGN.md — Food Delivery / Restaurant

## Aesthetic
playful

## Tone
Тёплый, аппетитный, дружелюбный

## Colors
bg: #fffaf0, accent: #e65100, accent2: #c62828
...
- Соблюдай Тёплый, аппетитный, дружелюбный тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #e65100, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #f0e6d8, text #2d1810 | bg #f0f2f5 | border #e65100 | opacity .4 |
| Ghost | bg transparent, text #8a7a6a | bg #f0f2f5 | text #2d1810 | opacity .4 |
...
|---|---|---|---|
| Default | #fffaf0 | #f0e6d8 | #2d1810 |
| Focus | #fffaf0 | #e65100 (+shadow) | #2d1810 |
| Error | #fffaf0 | #c62828 | #c62828 |
| Disabled | #f0f2f5 | #f0e6d8 | #8a7a6a |
- Height: 36px | Radius: 8px | Padding: 0 12px

## Card Specs
- Background: #ffffff | Border: 1px solid #f0e6d8 | Radius: 8px
- Padding: 16px | Hover: border #e65100 (if interactive)

## Navigation
- Link: #8a7a6a, hover #2d1810, active #e65100
- Tab active: bottom 2px #e65100, color #e65100
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #e65100 outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #e65100 for active
