# DESIGN.md — News / Media Portal

## Aesthetic
editorial-magazine

## Tone
Контент-плотный, информационный, респектабельный

## Colors
bg: #fafafa, accent: #cc3333, accent2: #1a1a2e
...
- Соблюдай Контент-плотный, информационный, респектабельный тон во всех текстах
...
| Focus | #fafafa | #cc3333 (+shadow) | #1a1a1a |
| Error | #fafafa | #cc3333 | #cc3333 |
| Disabled | #f0f2f5 | #e0e0e0 | #6b6b6b |
- Height: 36px | Radius: 4px | Padding: 0 12px

## Card Specs
- Background: #ffffff | Border: 1px solid #e0e0e0 | Radius: 4px
- Padding: 16px | Hover: border #cc3333 (if interactive)

## Navigation
- Link: #6b6b6b, hover #1a1a1a, active #cc3333
