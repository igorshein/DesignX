# DESIGN.md — TV / Streaming App

## Aesthetic
dark-glass

## Tone
Кинематографичный, иммерсивный, крупный

## Colors
bg: #0a0a0f, accent: #ff0044, accent2: #00e5ff
...
- Соблюдай Кинематографичный, иммерсивный, крупный тон во всех текстах
...
| Secondary | bg transparent, border rgba(255,255,255,.08), text #f0f0f5 | bg #14141f | border #ff0044 | opacity .4 |
| Ghost | bg transparent, text #7a7a90 | bg #14141f | text #f0f0f5 | opacity .4 |
...
| Focus | #0a0a0f | #ff0044 (+shadow) | #f0f0f5 |
| Error | #0a0a0f | #f14c4c | #f14c4c |
| Disabled | #14141f | rgba(255,255,255,.08) | #7a7a90 |
- Height: 36px | Radius: 4px | Padding: 0 12px

## Card Specs
- Background: #14141f | Border: 1px solid rgba(255,255,255,.08) | Radius: 4px
- Padding: 16px | Hover: border #ff0044 (if interactive)

## Navigation
- Link: #7a7a90, hover #f0f0f5, active #ff0044
