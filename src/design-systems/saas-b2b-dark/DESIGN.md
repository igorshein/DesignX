# DESIGN.md — SaaS B2B Dark

## Aesthetic
industrial-minimal

## Tone
Профессиональный, тёмный, дата-ориентированный

## Colors
bg: #0f111a, accent: #3b82f6, accent2: #22d3ee
...
- Соблюдай Профессиональный, тёмный, дата-ориентированный тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #3b82f6, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #262a36, text #e8ecf1 | bg #1a1d28 | border #3b82f6 | opacity .4 |
| Ghost | bg transparent, text #7a8295 | bg #1a1d28 | text #e8ecf1 | opacity .4 |
...
|---|---|---|---|
| Default | #0f111a | #262a36 | #e8ecf1 |
| Focus | #0f111a | #3b82f6 (+shadow) | #e8ecf1 |
| Error | #0f111a | #ef4444 | #ef4444 |
| Disabled | #1a1d28 | #262a36 | #7a8295 |
- Height: 36px | Radius: 6px | Padding: 0 12px

## Card Specs
- Background: #1a1d28 | Border: 1px solid #262a36 | Radius: 6px
- Padding: 16px | Hover: border #3b82f6 (if interactive)

## Navigation
- Link: #7a8295, hover #e8ecf1, active #3b82f6
- Tab active: bottom 2px #3b82f6, color #3b82f6
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #3b82f6 outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #3b82f6 for active
