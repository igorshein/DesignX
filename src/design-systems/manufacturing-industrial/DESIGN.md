# DESIGN.md — Manufacturing / Industrial

## Aesthetic
brutalist-raw

## Tone
Промышленный, SCADA, оперативный

## Colors
bg: #0d1117, accent: #ff6600, accent2: #ffff00
...
- Соблюдай Промышленный, SCADA, оперативный тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #ff6600, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #21262d, text #c9d1d9 | bg #161b22 | border #ff6600 | opacity .4 |
| Ghost | bg transparent, text #8b949e | bg #161b22 | text #c9d1d9 | opacity .4 |
...
|---|---|---|---|
| Default | #0d1117 | #21262d | #c9d1d9 |
| Focus | #0d1117 | #ff6600 (+shadow) | #c9d1d9 |
| Error | #0d1117 | #da3633 | #da3633 |
| Disabled | #161b22 | #21262d | #8b949e |
- Height: 36px | Radius: 2px | Padding: 0 12px

## Card Specs
- Background: #161b22 | Border: 1px solid #21262d | Radius: 2px
- Padding: 16px | Hover: border #ff6600 (if interactive)

## Navigation
- Link: #8b949e, hover #c9d1d9, active #ff6600
- Tab active: bottom 2px #ff6600, color #ff6600
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #ff6600 outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #ff6600 for active
