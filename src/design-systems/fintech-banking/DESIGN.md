# DESIGN.md — FinTech / Banking

## Aesthetic
industrial-minimal

## Tone
Надёжный, профессиональный, консервативный

## Colors
bg: #0d1117, accent: #238636, accent2: #58a6ff
...
- Соблюдай Надёжный, профессиональный, консервативный тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #238636, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #21262d, text #e6edf3 | bg #161b22 | border #238636 | opacity .4 |
...
|---|---|---|---|
| Default | #0d1117 | #21262d | #e6edf3 |
| Focus | #0d1117 | #238636 (+shadow) | #e6edf3 |
| Error | #0d1117 | #da3633 | #da3633 |
| Disabled | #161b22 | #21262d | #8b949e |
- Height: 36px | Radius: 6px | Padding: 0 12px

## Card Specs
- Background: #161b22 | Border: 1px solid #21262d | Radius: 6px
- Padding: 16px | Hover: border #238636 (if interactive)

## Navigation
- Link: #8b949e, hover #e6edf3, active #238636
- Tab active: bottom 2px #238636, color #238636
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #238636 outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #238636 for active
