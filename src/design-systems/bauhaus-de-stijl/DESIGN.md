# DESIGN.md — Bauhaus / De Stijl

## Aesthetic
art-deco-geometric

## Tone
Геометрический, цветовой, асимметричный

## Colors
bg: #ffffff, accent: #cc0000, accent2: #0033cc
...
- Соблюдай Геометрический, цветовой, асимметричный тон во всех текстах
...
|---|---|---|---|---|
| Primary | bg #cc0000, #fff | darker 10% | opacity .85 | opacity .4 |
| Secondary | bg transparent, border #000000, text #1a1a1a | bg #f0f2f5 | border #cc0000 | opacity .4 |
...
|---|---|---|---|
| Default | #ffffff | #000000 | #1a1a1a |
| Focus | #ffffff | #cc0000 (+shadow) | #1a1a1a |
| Error | #ffffff | #cc0000 | #cc0000 |
| Disabled | #f0f2f5 | #000000 | #555555 |
- Height: 36px | Radius: 0px | Padding: 0 12px

## Card Specs
- Background: #f5f0e8 | Border: 1px solid #000000 | Radius: 0px
- Padding: 16px | Hover: border #cc0000 (if interactive)

## Navigation
- Link: #555555, hover #1a1a1a, active #cc0000
- Tab active: bottom 2px #cc0000, color #cc0000
- Sidebar: padding 8px 16px

## Accessibility
- Contrast: WCAG AA (4.5:1 normal, 3:1 large)
- Focus: 2px #cc0000 outline + offset
- Target: min 44x44px interactive
- Motion: respects prefers-reduced-motion

## Iconography
- Style: outline (1.5px), sizes 16/20/24px
- Color: inherits text; #cc0000 for active
