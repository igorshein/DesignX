# DESIGN.md — VR / AR Interface

## Aesthetic
cyberpunk

## Tone
Иммерсивный, футуристический, пространственный

## Colors
bg: #050510, accent: #00e5ff, accent2: #b388ff
...
- Соблюдай Иммерсивный, футуристический, пространственный тон во всех текстах
...
| Secondary | bg transparent, border #1a2a3a, text #e0f0ff | bg #0d0d20 | border #00e5ff | opacity .4 |
| Ghost | bg transparent, text #6a7a9a | bg #0d0d20 | text #e0f0ff | opacity .4 |
...
|---|---|---|---|
| Default | #050510 | #1a2a3a | #e0f0ff |
| Focus | #050510 | #00e5ff (+shadow) | #e0f0ff |
| Error | #050510 | #ff1744 | #ff1744 |
| Disabled | #0d0d20 | #1a2a3a | #6a7a9a |
- Height: 36px | Radius: 4px | Padding: 0 12px

## Card Specs
- Background: #0d0d20 | Border: 1px solid #1a2a3a | Radius: 4px
- Padding: 16px | Hover: border #00e5ff (if interactive)

## Navigation
- Link: #6a7a9a, hover #e0f0ff, active #00e5ff
